      ...
      <div className="bg-slate-900 dark:bg-slate-950 rounded-3xl overflow-hidden shadow-2xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 border border-slate-800">
        ...
        <div className="flex">
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center gap-6 p-8 bg-gradient-to-r from-slate-800 to-slate-700">
              {/* Small left image */}
              ...
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <span className="text-xs bg-slate-700 text-purple-400 rounded-full px-3 py-1 flex items-center gap-1.5 border border-purple-600/30">
                    <span>🙏</span>
                    {product.category}
                  </span>
                </div>
                <p className="text-amber-400 text-sm font-medium">{product.tagline}</p>
              </div>
            ...
            {/* Description */}
            <div className="px-8 py-4 bg-slate-800">
              <p className="text-slate-300 text-sm leading-relaxed">{product.description}</p>
            </div>

            {/* Features grid */}
            {product.featureDetails && (
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4 px-8 py-6 bg-slate-800 border-t border-slate-700">
            ...
            <div className="px-8 py-6 bg-slate-800 border-t border-slate-700 flex items-center justify-between">
              {/* Testimonial */}
              ...
              {/* CTA Button */}
              <button className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-semibold py-2 px-6 rounded-full flex items-center gap-2 transition-all duration-200 hover:gap-3 whitespace-nowrap">
                View Details
                <span>→</span>
              </button>
            </div>
