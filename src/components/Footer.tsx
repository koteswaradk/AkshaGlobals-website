          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              <li className="flex items-start gap-3">
                ...
                <span className="text-m3-dark-on-surface-variant leading-relaxed">
              ...
              <li className="flex items-center gap-3">
                ...
                <span className="text-m3-dark-on-surface-variant">+91 98765 43210</span>
              </li>
              <li className="flex items-center gap-3">
                <svg className="w-5 h-5 text-m3-primary-container flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
                </svg>
                <span className="text-m3-dark-on-surface-variant">info@akshaglobals.com</span>
              </li>
            </ul>
          </div>
